...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar */}
      <nav className="flex items-center justify-between px-6 py-4 bg-white shadow-md fixed top-0 left-0 w-full z-20">
        <Link to="/" className="font-bold text-xl text-indigo-700">QuickShift</Link>
        <div className="flex gap-3 items-center">
          <LanguageSwitcher />
          <button
            className="text-sm px-4 py-2 bg-indigo-100 text-indigo-700 rounded hover:bg-indigo-200 font-medium"
      ...
      <div className="pt-24 max-w-md mx-auto mt-10 bg-white p-6 rounded shadow">
        ...
        {/* Switching button for login/register */}
