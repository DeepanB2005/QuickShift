  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      ...
      <nav className={`flex items-center justify-between px-6 py-4 bg-gradient-to-r from-blue-300 to-red-300 shadow-md fixed top-0 left-0 w-full z-20 transition-all duration-300 ${scrollY > 50 ? 'bg-purple-900/95 backdrop-blur-md' : 'bg-transparent'}`}>
        <Link to="/" className="font-bold text-xl text-indigo-700">SwiftShift</Link>
        
        <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
          <a href="#services" className="hover:text-pink-400 transition-colors text-sm lg:text-base">Services</a>
          <a href="#features" className="hover:text-pink-400 transition-colors text-sm lg:text-base">Features</a>
          <a href="#about" className="hover:text-pink-400 transition-colors text-sm lg:text-base">About</a>
          <button 
        ...
        <div className="flex gap-3 items-center">
          ...
          {token ? (
            ...
            <Link className="text-sm px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition" to="/auth">Login</Link>
          )}
        </div>
      ...
      <div className={`md:hidden transition-all duration-300 ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'} overflow-hidden bg-purple-900/95 backdrop-blur-md`}>
        <div className="px-4 py-6 space-y-4">
          <a href="#services" className="block hover:text-pink-400 transition-colors">Services</a>
          <a href="#features" className="block hover:text-pink-400 transition-colors">Features</a>
          <a href="#about" className="block hover:text-pink-400 transition-colors">About</a>
          <button 
            onClick={() => window.location.href = '/auth'}
      ...
      <div className="pt- px-4 md:px-8 lg:px-0 max-w- mx-auto">
        {/* Hero Section */}
        <section className="relative min-h-screen flex items-center justify-center px-4 pt-20">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center px-3 py-2 sm:px-4 sm:py-2 bg-pink-500/20 rounded-full mb-6 backdrop-blur-sm border border-pink-400/30">
              ...
              <span className="text-xs sm:text-sm">Trusted by 50,000+ users</span>
            </div>
        ...
        <section id="features" className="py-12 sm:py-16 lg:py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
                Why Choose <span className="text-pink-400">QuickShift</span>
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-4xl mx-auto px-4">
